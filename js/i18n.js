...
export const STRINGS = {
  en: {
    ...
    landing_btn_result: "Check Result",
    landing_btn_admin: "Admin Login",
    landing_btn_teacher_desc: "Submit your 5 ranked panchayat preferences",
    landing_btn_result_desc: "View your allocated panchayat once results are published",
    landing_btn_admin_desc: "District Education Office only",
  ...
  hi: {
    ...
    landing_admin_pic_label: "सहरसा प्रशासन",
    landing_btn_teacher: "शिक्षक पोर्टल",
    landing_btn_result: "परिणाम देखें",
    landing_btn_admin: "प्रशासक लॉगिन",
    landing_btn_teacher_desc: "क्रम में अपनी 5 पंचायत वरीयताएँ जमा करें",
    landing_btn_result_desc: "परिणाम प्रकाशित होने पर अपनी आवंटित पंचायत देखें",
    landing_btn_admin_desc: "केवल ज़िला शिक्षा कार्यालय हेतु",
